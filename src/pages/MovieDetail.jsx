  ...
  return (
    <div className=" dark:bg-gray-900">
      <div className="md:container px-10 mx-auto py-5  ">
        ...
        <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white dark:bg-gray-900  md:text-5xl lg:text-6xl flex justify-center">
          {title}
        </h1>
        <div className="md:container flex justify-center px-10 ">
          <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-100 shadow-lg">
            <img
              className=" lg:w-1/3 h-96 lg:h-[600px] object-cover rounded-t-lg md:rounded-none md:rounded-l-lg dark:bg-gray-900 "
              src={poster_path ? baseImageUrl + poster_path : defaultImage}
              alt="poster"
            />

            <div className="p-6 flex flex-col justify-between dark:bg-gray-900 dark:text-white ">
              <div>
